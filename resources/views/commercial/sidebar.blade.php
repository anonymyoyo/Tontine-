<nav id="sidebar" class="sidebar-wrapper">
    ...
    <div class="sidebarMenuScroll">
      ...
      <ul class="sidebar-menu">
        ...
        <li>
            <a href="{{ route('commercial.agences') }}">
                <i class="bi bi-border-all"></i>
                <span class="menu-text">Agences</span>
            </a>
        </li>
        <li>
            <a href="{{ route('commercial.zones') }}">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                @foreach ($tontine as $tontines)
                    <li>
                        <a href="{{ route('commercial.tontine', $tontines->id) }}">{{ $tontines->name }}</a>
                    </li>
                @endforeach
                {{-- <li>
        ...
        <li>
          <a href="{{ route('commercial.membres') }}">
