      ...
      <div class="main-container">
        ...
        <div class="app-container">
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <ol class="breadcrumb">
                <li class="breadcrumb-item">
                  ...
                  <a href="{{ route('association') }}" class="text-decoration-none">Ajouter</a>
                </li>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              <!-- Row start -->
              <form action="{{ route('association.ajouter.commercial') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row gx-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="budget" class="form-control" required placeholder="Enter province/territory" />
                    </div>
                    </div>
                    <div class="col-lg-3 col-sm-4 col-12">
                    <div class="mb-3">
                        <label class="form-label">Piece d'identite</label>
                        <input type="file" name="identification" class="form-control" required placeholder="Enter postal code" />
                    </div>
                    </div>
                    <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
