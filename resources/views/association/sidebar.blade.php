<nav id="sidebar" class="sidebar-wrapper">
    ...
    <div class="sidebarMenuScroll">
      ...
      <ul class="sidebar-menu">
        ...
        <li>
            <a href="{{ route('association.agences') }}">
                <i class="bi bi-border-all"></i>
                <span class="menu-text">Agences</span>
            </a>
        </li>
        <li>
            <a href="{{ route('association.zones') }}">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                @foreach ($tontine as $tontines)
                    <li>
                        <a href="{{ route('association.tontine', $tontines->id) }}">{{ $tontines->name }}</a>
                    </li>
                @endforeach
                {{-- <li>
        ...
        <li>
          <a href="{{ route('association.chef_agence') }}">
            <i class="bi bi-check-circle"></i>
            <span class="menu-text">Chefs Agences</span>
          </a>
        </li>
        <li>
            <a href="{{ route('association.commercial') }}">
                <i class="fs-3 bi bi-people"></i>
              <span class="menu-text">Commerciaux</span>
            </a>
        </li>
        <li>
          <a href="{{ route('association.transaction') }}">
            <i class="bi bi-wallet2"></i>
            <span class="menu-text">Transactions</span>
          </a>
        </li>
        <li>
            <a href="{{ route('association.versement') }}">
              <i class="bi bi-wallet2"></i>
              <span class="menu-text">Versement</span>
            </a>
          </li>
        <li>
          <a href="{{ route('association.reglage') }}">
