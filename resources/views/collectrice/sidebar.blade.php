    ...
    <div class="sidebarMenuScroll">
      ...
      <ul class="sidebar-menu">
        <li class="active current-page">
          <a href="{{ route('collectrice') }}">
            <i class="bi bi-pie-chart"></i>
            <span class="menu-text">Dashboard</span>
          </a>
        </li>
        <li>
            <a href="{{ route('collectrice.agences') }}">
                <i class="bi bi-border-all"></i>
                <span class="menu-text">Agences</span>
            </a>
        </li>
        <li>
            <a href="{{ route('collectrice.zones') }}">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                @foreach ($tontine as $tontines)
                    <li>
                        <a href="{{ route('collectrice.tontine', $tontines->id) }}">{{ $tontines->name }}</a>
                    </li>
                @endforeach
                {{-- <li>
        ...
        <li>
          <a href="{{ route('collectrice.chef_agence') }}">
            <i class="bi bi-check-circle"></i>
            <span class="menu-text">Chefs Agences</span>
          </a>
        </li>
        <li>
            <a href="{{ route('collectrice.commercial') }}">
                <i class="fs-3 bi bi-people"></i>
              <span class="menu-text">Commerciaux</span>
            </a>
        </li>
        <li>
          <a href="{{ route('collectrice.transaction') }}">
            <i class="bi bi-wallet2"></i>
            <span class="menu-text">Transactions</span>
          </a>
        </li>
        {{-- <li>
            <a href="{{ route('commercial.versement') }}">
              <i class="bi bi-wallet2"></i>
              <span class="menu-text">Versement</span>
            </a>
          </li>
        <li>
          <a href="{{ route('commercial.reglage') }}">
            <i class="bi bi-gear"></i>
            <span class="menu-text">Settings</span>
          </a>
        </li> --}}
        <li>
          <a href="{{ route('collectrice.membres') }}">
