                        ...
                        <div class="col-xxl-12">
                            <div class="breadcrumb__content p-relative z-index-1">
                                ...
                                <div class="breadcrumb__list">
                                    <span>Retourner a l'<a href="{{ route('home') }}">acceuil ici</a></span>
                                    {{-- <span>Catalogue</span> --}}
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <div class="tp-product-item-2 mb-40">
                                                        ...
                                                        <div class="tp-product-content-2 pt-15">
                                                            ...
                                                            <div class="tp-product-price-wrapper-2">
                                                                <span
                                                                    class="tp-product-price-2 new-price">{{ $product->prix_cash }} XAF</span>
                                                                <span
                                                                    class="tp-product-price-2 old-price">{{ $product->prix_tontine }} XAF</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
