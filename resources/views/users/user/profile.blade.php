...
<head>
    ...
    {{-- <link rel="stylesheet" href="{{ asset('assets/css/style.css') }}" /> --}}
     <link rel="stylesheet" href="{{ asset('asets/css/bootstrap.css') }}" />
    <link rel="stylesheet" href="{{ asset('asets/css/animate.css') }}" />
    <link rel="stylesheet" href="{{ asset('asets/css/swiper-bundle.css') }}" />
    <link rel="stylesheet" href="{{ asset('asets/css/slick.css') }}" />
    <link rel="stylesheet" href="{{ asset('asets/css/magnific-popup.css') }}" />
    <link rel="stylesheet" href="{{ asset('asets/css/font-awesome-pro.css') }}"/>
     <link rel="stylesheet" href="{{ asset('asets/css/flaticon_shofy.css') }}" />
    ...
    <style>
        * {
            ...
            header {
                height: 100px;
                width: 100vw;
                /* background: url('public/asset/img.1.png'); */
            ...
            .retour_arriere a .retourarriere {
                width: 60px;
                height: 60px;
                position: fixed;
            }
...
<body>
    ...
    {{-- <nav class="navbar">
        ...
        <img src="{{ Storage::url(auth()->user()->image) }}" class="menu-hamburger" alt="image de profil">
    </nav> --}}
        <!-- profile area start -->
                    ...
                    <div class="col-xxl-4 col-lg-4">
                        <div class="profile__tab mr-40">
                            ...
                            <div class="nav nav-tabs tp-tab-menu flex-column" id="profile-tab" role="tablist">
                                ...
                                <button class="nav-link" id="nav-information-tab" data-bs-toggle="tab" data-bs-target="#nav-information" type="button" role="tab" aria-controls="nav-information" aria-selected="false"><span><i class="fa-regular fa-circle-info"></i></span> Informations</button>
                                <button class="nav-link" id="nav-address-tab" data-bs-toggle="tab" data-bs-target="#nav-address" type="button" role="tab" aria-controls="nav-address" aria-selected="false"><span><i class="fa-light fa-location-dot"></i></span> Addresse </button>
                                ...
                                <button class="nav-link" id="nav-password-tab" data-bs-toggle="tab" data-bs-target="#nav-password" type="button" role="tab" aria-controls="nav-password" aria-selected="false"><span><i class="fa-regular fa-lock"></i></span> Changer Mot de passe</button>
                        ...
                        <div class="profile__tab-content">
                                        ...
                                        <div class="col-md-6">
                                            <div class="profile__main-inner d-flex flex-wrap align-items-center">
                                                <div class="profile__main-thumb">
                                                    <img src="{{ Storage::url(auth()->user()->image) }}" alt="image de profil">
                                                ...
                                                <div class="profile__main-content">
                                                    <h4 class="profile__main-title">Bienvenue {{ auth()->user()->name }}!</h4>
                                                    <p>Numero ID :<span>00000{{ auth()->user()->id }}</span> </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="profile__main-logout text-sm-end">
                                                ...
                                                <li><form action="{{ route('logout') }}" method="POST" id="logout">
                                                    ...
                                                    <a class="tp-logout-btn" onclick="event.preventDefault();
                                    ...
                                    <div class="profile__main-info">
                                        ...
                                        <div class="col-md-3 col-sm-6">
                                            <div class="profile__main-info-item">
                                                ...
                                                <h4 class="profile__main-info-title">Transactions</h4>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                            <div class="profile__main-info-item">
                                        ...
                                        <div class="col-md-3 col-sm-6">
                                            <div class="profile__main-info-item">
                                                ...
                                                <h4 class="profile__main-info-title">Favoris</h4>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                            <div class="profile__main-info-item">
                                                ...
                                                <h4 class="profile__main-info-title">TCA bonus</h4>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="nav-information" role="tabpanel" aria-labelledby="nav-information-tab">
                                <div class="profile__info">
                                    <h3 class="profile__info-title">Informations personnelles</h3>
                                    <div class="profile__info-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xxl-6 col-md-6">
                                                <div class="profile__input-box">
                                                    <div class="profile__input">
                                                    <input type="email" placeholder="Enter your email" value="{{ auth()->user()->email }}">
                                                    <span>
                                            ...
                                            <div class="col-xxl-6 col-md-6">
                                                <div class="profile__input-box">
                                                    <div class="profile__input">
                                                    <input type="text" placeholder="Enter your number" value="{{ auth()->user()->phone }}">
                                                    <span>
                                            ...
                                            <div class="col-xxl-12">
                                                <div class="profile__input-box">
                                                    <div class="profile__input">
                                                    <input type="text" placeholder="Enter your address" value="{{ auth()->user()->ville }},{{ auth()->user()->pays }}">
                                                    <span>
                                            ...
                                            <div class="col-xxl-12">
                                                <div class="profile__btn">
                                                    <button type="submit" class="tp-btn">Mettre a jour</button>
                                                </div>
                                            </div>
                                        </div>
                                        </form>
                                    ...
                                    <form action="#">
                                        ...
                                        <div class="col-xxl-6 col-md-6">
                                            <div class="tp-profile-input-box">
                                                ...
                                                <div class="tp-profile-input-title">
                                                    <label for="con_new_pass">Confirmer Mot de passe</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xxl-6 col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="profile__address-item d-sm-flex align-items-start">
                                            ...
                                            <div class="profile__address-content">
                                                <h3 class="profile__address-title">Addresse Contoir/Boutique</h3>
                                                <form action="#">
                                                    <label><span>Street:</span>3576 Glen Street</label>
                                                    <input type="text"><br>
                                                    <label><span>City:</span>Summer Shade</label>
                                                    <input type="text"><br>
                                                    <label><span>State/province/area:</span>Kentucky</label>
                                                    <input type="text"><br>
                                                    <label><span>Phone number:</span>270-428-8378</label>
                                                    <input type="text"><br>
                                                    <label><span>Zip code:</span>42166</label>
                                                    <input type="text"><br>
                                                    <label><span>Country calling code:</span> +1</label>
                                                    <input type="text"><br>
                                                    <label><span>Country:</span>United States</label>
                                                    <input type="text">
                                        ...
                                        <div class="profile__address-item d-sm-flex align-items-start">
                                            ...
                                            <div class="profile__address-content">
                                                ...
                                                <form action="#">
                                                    <label><span>Street:</span>3133 Lewis Street</label>
                                                    <input type="text"><br>
                                                    <label><span>City:</span>Naperville</label>
                                                    <label><span>Country:</span>United States</label><br>
                                                    <label><span>State/province/area:</span>Illinois</label>
                                                    <input type="text"><br>
                                                    <label><span>Phone number:</span>630-857-9127</label>
                                                    <input type="text"><br>
                                                    <label><span>Zip code:</span> 60563</label>
                                                    <input type="text"><br>
                                                    <label><span>Country calling code:</span>+1</label>
                                                    <input type="text"><br>
                                                    <label><span>Country:</span>United States</label>
      ...
      <script>
        ...
        <!-- JS here -->
      <script src="{{ asset('asets/js/vendor/jquery.js')}}"></script>
      <script src="{{ asset('asets/js/vendor/waypoints.js')}}"></script>
      <script src="{{ asset('asets/js/bootstrap-bundle.js')}}"></script>
      <script src="{{ asset('asets/js/meanmenu.js')}}"></script>
      <script src="{{ asset('asets/js/swiper-bundle.js')}}"></script>
      <script src="{{ asset('asets/js/slick.js')}}"></script>
      <script src="{{ asset('asets/js/range-slider.js')}}"></script>
      <script src="{{ asset('asets/js/magnific-popup.js')}}"></script>
      <script src="{{ asset('asets/js/nice-select.js')}}"></script>
      <script src="{{ asset('asets/js/purecounter.js')}}"></script>
      <script src="{{ asset('asets/js/countdown.js')}}"></script>
      <script src="{{ asset('asets/js/wow.js')}}"></script>
      <script src="{{ asset('asets/js/isotope-pkgd.js')}}"></script>
      <script src="{{ asset('asets/js/imagesloaded-pkgd.js')}}"></script>
      <script src="{{ asset('asets/js/ajax-form.js')}}"></script>
