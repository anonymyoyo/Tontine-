...
<body>
    <!--[if lte IE 9]>
      ...
      {{-- <div class="user_profil">
        <div class="user_nav">
            <nav>
                <ul> <img src="#" class="image_profile" alt="image de profil">
                <li>Notifications</li>
                <li>Panier</li>
                <li>Recherche</li>
...
<!-- Mirrored from html.hixstudio.net/shofy-prv/shofy/profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 May 2024 11:55:45 GMT -->
</html>
