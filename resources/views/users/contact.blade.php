        ...
        <div class="container">
            <div class="banner-wrapper">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ ('home') }}" class="large">Acceuil</a></li>
                        ...
                        <div class="contact-form-left-column">
                            ...
                            <div class="contact-left-single-item d-flex align-items-center">
                                <div class="contact-item-thumb">
                                    <img src="assets/images/custom/contact/contact-mail.png" alt="Mail">
                                </div>
                            ...
                            <div class="contact-left-single-item d-flex align-items-center">
                                <div class="contact-item-thumb">
                                    <img src="assets/images/custom/contact/contact-phone.png" alt="Phone">
                                </div>
                                <div class="contact-item-info">
                            ...
                            <div class="social-wrapper">
                                ...
                                <a href="#">
                                    <img src="assets/icons/custom/instagram.png" alt="Instagram">
                                </a>
                                <a href="#">
                                ...
                                <div class="d-flex flex-column flex-md-row">
                                    <div class="full-name">
                                        ...
                                        <div class="icon-wrapper-input">
                                            ...
                                            <img src="assets/icons/custom/user.png" alt="User">
                                        </div>
                                    </div>
                                    <div class="email-address ml-0">
                                        ...
                                        <div class="icon-wrapper-input">
                                            ...
                                            <img src="assets/icons/custom/mail.png" alt="Email">
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex flex-column flex-md-row">
