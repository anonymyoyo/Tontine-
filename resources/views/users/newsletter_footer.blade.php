    ...
    <footer>
      <div class="footer-navbar">
        <nav class="footer-nav">
          <ul>
            <a class="nav-title">ACCEUIL</a>
            {{-- <div class="separator"></div>
            <a>Devenir Commercial</a><br>
            <a>Devenir Collectrice</a><br>
            <a>Trouver un point de vente</a><br>
            <a>Nos Partenaires</a> --}}
          </ul>
        </nav>
        <nav class="footer-nav">
            <ul>
              <a class="nav-title">SERVICES</a>
            </ul>
        </nav>
        <nav class="footer-nav">
            <ul>
              <a class="nav-title">AGENT</a>
            </ul>
        </nav>
        <nav class="footer-nav">
            <ul>
              <a class="nav-title" href="{{ route('catalogue') }}">CATALOGUE</a>
            </ul>
        </nav>
      </div>
...
<!-- footer area start -->
        <!-- <footer>
            <div class="tp-footer-area tp-footer-style-2 tp-footer-style-primary tp-footer-style-6"
